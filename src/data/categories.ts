...
export const categories: Category[] = [
  {
    ...
    coverImage: `${IK}/kuhinje/naslovna_k.jpeg`,
    gallery: [
      ...
      { src: `${IK}/kuhinje/naslovna_k-2.jpeg`, alt: "Kuhinja po meri — slika 8" },
      { src: `${IK}/kuhinje/k8.jpeg`, alt: "Kuhinja po meri — slika 9" },
      { src: `${IK}/kuhinje/k9.jpeg`, alt: "Kuhinja po meri — slika 10" },
      { src: `${IK}/kuhinje/k10.jpeg`, alt: "Kuhinja po meri — slika 11" },
      { src: `${IK}/kuhinje/k11.jpeg`, alt: "Kuhinja po meri — slika 12" },
    ],
  },
  {
    id: "kopalnice",
