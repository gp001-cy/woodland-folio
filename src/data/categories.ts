...
export const categories: Category[] = [
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: `${IK}/VgradneOmare/q3.jpeg`, alt: "Vgradna omara — slika 4" },
      { src: `${IK}/VgradneOmare/q4.jpeg`, alt: "Vgradna omara — slika 5" },
      { src: `${IK}/VgradneOmare/q5.jpeg`, alt: "Vgradna omara — slika 6" },
      { src: `${IK}/VgradneOmare/q6.jpeg`, alt: "Vgradna omara — slika 7" },
      { src: `${IK}/VgradneOmare/q7.jpeg`, alt: "Vgradna omara — slika 8" },
    ],
  },
  {
    id: "predsobe",
  ...
  },
  {
    ...
    coverImage: `${IK}/naslovstopnice.jpeg`,
    gallery: [
