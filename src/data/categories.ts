...
export const categories: Category[] = [
  {
    ...
    gallery: [
      ...
      { src: `${IK}/kuhinje/k12.jpeg`, alt: "Kuhinja po meri — slika 12" },
      { src: `${IK}/kuhinje/k13.jpeg`, alt: "Kuhinja po meri — slika 13" },
      { src: `${IK}/kuhinje/k14.jpeg`, alt: "Kuhinja po meri — slika 14" },
      { src: `${IK}/kuhinje/k15.jpeg`, alt: "Kuhinja po meri — slika 15" },
    ],
  },
  {
    id: "kopalnice",
