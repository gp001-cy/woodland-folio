...
export const categories: Category[] = [
  {
    ...
    coverImage: "/kuhinje/naslovna k.jpg",
    gallery: [
      { src: "/kuhinje/k1.jpg", alt: "Kuhinja po meri — slika 1" },
      { src: "/kuhinje/k2.jpg", alt: "Kuhinja po meri — slika 2" },
      { src: "/kuhinje/k3.jpg", alt: "Kuhinja po meri — slika 3" },
      { src: "/kuhinje/k4.jpg", alt: "Kuhinja po meri — slika 4" },
      { src: "/kuhinje/k5.jpg", alt: "Kuhinja po meri — slika 5" },
      { src: "/kuhinje/k6.jpg", alt: "Kuhinja po meri — slika 6" },
      { src: "/kuhinje/k7.jpg", alt: "Kuhinja po meri — slika 7" },
      { src: "/kuhinje/k8.jpg", alt: "Kuhinja po meri — slika 8" },
      { src: "/kuhinje/k9.jpg", alt: "Kuhinja po meri — slika 9" },
      { src: "/kuhinje/k10.jpg", alt: "Kuhinja po meri — slika 10" },
      { src: "/kuhinje/k11.jpg", alt: "Kuhinja po meri — slika 11" },
    ],
  },
  {
    id: "kopalnice",
